setwd("/ultraData/new_wb/HILICneg/mzML/")
# HILIC neg
library(OptiLCMS)
mSet1 <- ImportRawMSData(path = "MS1/")

mSet1 <- PerformPeakProfiling(mSet1, Params = SetPeakParam(ppm = 20, 
                                                           bw = 2, 
                                                           mzdiff = 0.001, 
                                                           max_peakwidth = 35, 
                                                           min_peakwidth = 2, 
                                                           noise = 500, minFraction = 0.5, snthresh = 3), 
                              ncore = 8, 
...
mSet1 <- qs::qread("../OptiLCMS_ms2/ms1/mSet1.qs")
